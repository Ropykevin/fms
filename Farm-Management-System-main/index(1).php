<html>
<head>
     <title>LUKENYA UNIVERSITY MANAGEMENT SYSTEM</title>
...
body{
    background-image : url("onion-farming.jpg");
}
</style>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp LUKENYA UNIVERSITY FARM MANAGEMENT SYSTEM</h4></a>
